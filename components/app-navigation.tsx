...
export function AppNavigation({ active }: { active?: "today" | "calendar" | "journal" | "nutrition" | "products" | "promotions" | "workouts" }) {
  return <>
    ...
    <nav className="mobile-bottom-nav" aria-label="Мобилна навигация">
      ...
      <details className="mobile-more">
        <summary className={active === "journal" || active === "products" || active === "promotions" || active === "workouts" ? "active" : ""}><NavIcon name="more" /><span>Още</span></summary>
        <div>
