...
export type DynamicMeal = { id: string; date: string; name: string; plannedTime: string | null; position: number; legacyPayload: Record<string, unknown> | null; items: DynamicMealItem[] };
