...
export type ProductPrice = { id: string; price: number; store: string; recordedAt: string };
export type FoodProduct = {
  id: string; name: string; brand: string; barcode: string; packageSize: string; servingGrams: number;
  calories100g: number; protein100g: number; carbs100g: number; fat100g: number; source: ProductSource;
  imageUrl: string; imagePath: string; favorite: boolean; priceHistory: ProductPrice[]; createdAt: string; updatedAt: string;
};
